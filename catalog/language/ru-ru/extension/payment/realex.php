...
// Text
$_['text_success']				= 'Ваш платеж подтвержден.';
$_['text_decline']				= 'Ваш платеж не может быть завершен';
...
$_['text_select_card']			= 'Выберите ваш тип карты';
$_['text_result']				= 'Auth result';
$_['text_message']				= 'Сообщение';
$_['text_cvn_result']			= 'CVN result';
$_['text_avs_postcode']			= 'Почтовый код AVS';
...
$_['text_card_name']			= 'Владелец карты';
...
$_['text_3d_liability']     	= 'Без передоверия обязательств';
