...
$_['text_authentication_not_completed'] = 'Начато, но не завершено';
$_['text_unable_to_perform'] = 'Выполнение невозможно';
$_['text_transaction_declined'] = 'Ваш банк отклонил транзакцию. Выберите другой способ платежа.';
$_['text_transaction_failed'] = 'Невозможно выполнить платеж. Проверьте данные платежа.';
$_['text_connection_error'] = 'Пожалуйста попробуйте позднее или выберите другой способ платежа.';

$_['entry_type'] = 'Подтвердить';
$_['entry_number'] = 'Номер карты';
$_['entry_expire_date'] = 'Срок действия карты';
$_['entry_cvv2'] = 'Секретный код карты (CVV2)';

$_['button_confirm'] = 'Подтвердить';

$_['error_failure'] = 'Транзакция не может быть завершена. Попробуйте позднее или выберите другой способ платежа.';