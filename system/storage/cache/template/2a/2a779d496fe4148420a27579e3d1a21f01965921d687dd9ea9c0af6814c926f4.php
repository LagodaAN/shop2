...
class __TwigTemplate_3905af4ddf0925e023fd33c04d7878145e93078f6b79e944fbc9a10c132bbe8f extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t 
          ...
          <div class=\"col-md-6 col-lg-4 col-xl-3\">
            <div class=\"card text-center card-product\">
              ...
              <div class=\"card-body\">
                <p>Букет</p> 
                <h4 class=\"card-product__title\"><a href=\"http://herzberg.p-host.in/index.php?route=product/product&path=67&product_id=56\">Бруния</a></h4>
          ...
          <div class=\"col-md-6 col-lg-4 col-xl-3\">
            <div class=\"card text-center card-product\">
              ...
              <div class=\"card-body\">
                <p>Букет</p>
                <h4 class=\"card-product__title\"><a href=\"product&path=70&product_id=59\">Гиперикум</a></h4>
          ...
          <div class=\"col-md-6 col-lg-4 col-xl-3\">
            <div class=\"card text-center card-product\">
              <div class=\"card-product__img\">
                <img class=\"card-img\" src=\"/image/catalog/craspedia/craspedia.png\" alt=\"\">
                <ul class=\"card-product__imgOverlay\">
  <li><button onclick=\"cart.add('58', '1');\"><i class=\"ti-shopping-cart\"></i></button></li>
              ...
              <div class=\"card-body\">
                <p>Accessories</p>
                <h4 class=\"card-product__title\"><a href=\"single-product.html\">Краспедия</a></h4>
                <p class=\"card-product__price\">270 руб.</p>
              </div>
            </div>
          </div>
